    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <TextInput id="input" placeholder="Enter Your task" value={text} onChangeText={onChangeText} style={styles.input} />
                ...
                <View style={{ flexDirection: "row", margin: 20 }}>
                    <Pressable style={{ width: 120, borderWidth: 1, opacity: 0.5, alignItems: "center", justifyContent: "space-around", borderRadius: 60, flexDirection: "row" }} onPress={() => { console.log("hii") }}>
                        ...
                        <Icon type="ionicon" name="calendar-outline" color='#000000' size={25} />
            ...
            <View style={{ flex: 0.5, justifyContent: "flex-start", alignItems: "center" }}>
                <View style={{ width: 150, opacity: 0.5, flexDirection: "row", justifyContent: "space-between" }}>
                    <Icon type="ionicon" name="folder-outline" color='#000000' size={30} />
                    <Icon type="ionicon" name="flag-outline" color='#000000' size={30} />
                    <Icon type="ionicon" name="moon-outline" color='#000000' size={30} />
                </View>
            </View>
